    ...
    <article className="max-w-[68ch]">
      ...
      */}
      {page.isFallback && (
        <p
          ...
          className="panel panel-notice text-text-muted mt-6 px-4 py-3 text-sm"
        >
      ...
      {page.frontmatter.translationStatus === 'machine' && !page.isFallback && (
        <p className="panel panel-notice text-text-muted mt-6 px-4 py-3 text-sm">
          {t('machineTranslated')}
        </p>
      )}
      ...
      */}
      {page.frontmatter.needsContent && page.body.trim() === '' && (
        <p className="panel text-text-muted mt-6 border-dashed px-4 py-5 text-sm">
          {t('awaitingContent')}
        </p>
      )}
